...
const STYLE_RULE = `STYLE DES TEXTES (le dossier est remis à un particulier) : écris SIMPLE et clair. Phrases courtes (une idée par phrase). Vocabulaire courant : pas de jargon (« ancre de valeur », « transposable », « décote conjoncturelle », « médiane des actés »…) — dis plutôt « les ventes réelles », « les biens comparables se sont vendus entre X et Y », « le marché refuse au-delà de Z ». Chaque texte d'analyse : 2 à 4 phrases maximum, compréhensibles à la première lecture par le vendeur.`;
...
- argumentaire_vendeur : 3 à 5 arguments chiffrés prêts à l'emploi pour le rendez-vous vendeur, DIGESTES : un argument par ligne (séparés par \\n), chacun au format « Titre court — explication en 1 à 2 phrases maximum ». Si le prix souhaité du vendeur est renseigné, l'un des arguments le positionne et le recadre si nécessaire.
