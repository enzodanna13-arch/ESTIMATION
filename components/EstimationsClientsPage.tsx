          ...
          <div className="p-6">
            ...
            <div className="mb-4 rounded-xl border border-slate-200 bg-white p-4">
              <div className="mb-2 flex items-center justify-between">
                ...
                <a href={`/estimation/resultat/${record.token}`} target="_blank" rel="noreferrer" className="text-xs font-semibold text-copper hover:underline">Voir le dossier client ↗</a>
              </div>
